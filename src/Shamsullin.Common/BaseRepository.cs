...
namespace Shamsullin.Common
{
	public abstract class BaseRepository
	{
		...
		public int InsertOrUpdate<T>(T record, string tableName, Expression<Func<T, object>>[] keyFields, params Expression<Func<T, object>>[] excludeFields)
		{
			...
			var nonNullColumns = columns.WhereArray(x => sqlParameters.Any(y => y.ParameterName.TrimStart('@') == x && y.Value != null));
